...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error("[REGISTER] Error calling getSupabaseClient:", clientError)
      setLoading(false)
    ...
    if (authData.user) {
      // The profile is automatically created by the handle_new_user trigger
      // We don't need to manually insert it, which was causing the database error
      console.log("[REGISTER] User registered successfully, profile should be created by trigger");
